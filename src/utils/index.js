...
/**
 *
 * @usage import { onValidate } from '@/utils/index.js'
 * @param {Object} obj 需要校验的对象
 * @param {Object} rule 匹配校验对象的规则
 * @return {null,Arror} err 校验结果
 */
export function onValidate(obj, rule) {
  var err = null
  var form = Object.assign({}, obj)
  var rules = Object.assign({}, rule)
 ...
 * @returns string tel
 */
export function telDesensitization(tel = '') {
  var len = tel.length
  if (len && len > 4) {
