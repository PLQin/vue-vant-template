  ...
  <div id="mineEntry">
    <div class="user-template">
      <van-sticky>
        <header class="aui-header-default aui-header aui-header-bg gp-nav-bar">
          ...
          <a href="#/mine/setting" class="aui-header-item-icon">
        ...
        <div class="aui-me-content-box">
          ...
          <div class="aui-me-content-list">
            <div class="aui-me-content-item">
              <div class="aui-me-content-item-head">
                <div class="aui-me-content-item-img">
                  <img :src="userInfo.headimgurl || imgs.head3" alt>
                </div>
                <div class="aui-me-content-item-title">{{ userInfo.nickname || '未登录' }}</div>
              </div>
              <div class="aui-me-content-item-text">
                <a href="/my-orders.html" @click="goToMyOrder">
                  <span>0.00</span>
                  <span>钱包</span>
                </a>
                <a href="#/mine/bill" @click="goIntegralDetails">
                  <span>0</span>
                  <span>积分</span>
                </a>
                <a href="#/collect" @click="goCollect">
                  <span>0</span>
                  <span>收藏</span>
                </a>
                <a href="/my-orders.html" @click="goToMyOrder">
            ...
            <div class="aui-me-content-card">
              <h3>
                <i class="aui-icon aui-card-me" />会员
              </h3>
              <!-- <a href="#/mine/membership">点击查看特权</a> -->
            </div>
          </div>
        </div>
      </section>
    ...
    <div class="list">
      ...
      <ul class="account-item">
        <li>
          <router-link :to="{path: '/my-car-sharing', query:{}}" tag="div">
            <i class="iconfont icon-yewujieshao-chengjipinche" />
            <div>
              <span>我的拼车</span>
            </div>
          </router-link>
    ...
    <div class="list">
      ...
      <ul class="account-item">
        <li>
          <router-link :to="{path: '/sales', query:{}}" tag="div">
            <i class="iconfont icon-wode-lianxikefu" />
            <div>
              <span>联系客服</span>
            </div>
          </router-link>
        ...
        <li>
          <router-link :to="{path: '/user-agreement', query:{}}" tag="div">
...
export default {
  ...
  created() {
    console.log(JSON.stringify(this.userInfo, null, 4))
  },
  methods: {
    goToMyOrder() {
    ...
    goIntegralDetails() {
      this.$router.push({ name: 'mineBill' })
    },
